...
int main(int argc, char *argv[]) {
  ...
  clht_t *hashtable = init_clht(pmem_path, pmem_size_in_mib, layout_name);

  if (mt) {
    read_op_and_run_mt(op_file_path, output_file_path, hashtable);
  } else {
    read_op_and_run(op_file_path, output_file_path, hashtable);
  }
