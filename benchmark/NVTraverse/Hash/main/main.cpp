...
#include "include/HashTraverse-ciri.h"
...
void run_op(char **op, HashTraverse<int>* list, FILE *output_file) {
  int key;
  int value;
  bool ret;
  switch (op[0][0]) {
...
void run_ops_in_parallel(char* ops[][3], HashTraverse<int>* list, FILE *output_file) {
...
int main(int argc, char *argv[]) {
  ...
  HashTraverse<int>* list = init_hash(pmem_path, pmem_size_in_mib, layout_name);
