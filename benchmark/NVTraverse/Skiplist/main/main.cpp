...
#include "include/SkiplistTraverse-ciri.h"
...
void run_op(char **op, SkiplistTraverse<int>* list, FILE *output_file) {
  int key;
  int value;
  bool ret;
  switch (op[0][0]) {
...
void run_ops_in_parallel(char* ops[][3], SkiplistTraverse<int>* list, FILE *output_file) {
...
int main(int argc, char *argv[]) {
  ...
  SkiplistTraverse<int>* list = init_skiplist(pmem_path, pmem_size_in_mib, layout_name);
